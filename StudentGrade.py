...
total_midterm_scores = 0
for score in midterm_scores:
    total_midterm_scores += score

total_final_scores = 0
for score in final_scores:
    total_final_scores += score
print('\nAverage midterm score:', round(total_midterm_scores/num_midterm_scores,2))
print('\nAverage Final score:', round(total_final_scores/num_final_scores,2))